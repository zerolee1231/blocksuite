...
import { SymbolRefBlockService } from './divider-block/index.js';
...
import { SymbolBlockService } from './symbol-block/index.js';
...
export const blockService = {
  ...
  'affine:divider': SymbolRefBlockService,
  'affine:note': NoteBlockService,
  'affine:bookmark': BookmarkBlockService,
  'affine:symbol': SymbolBlockService,
} satisfies {
