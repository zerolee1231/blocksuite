...
import { tooltipStyle } from '../../../components/index.js';
import { onClickOutside } from '../../../database-block/utils/utils.js';
import { asyncFocusRichText } from '../../utils/common-operations.js';
...
@customElement('affine-data-view-table')
export class DataViewTable extends WithDisposable(ShadowlessElement) {
  static override styles = styles;

  @property({ attribute: false })
  view!: DatabaseTableViewManager;
...
declare global {
  interface HTMLElementTagNameMap {
    'affine-data-view-table': DataViewTable;
  }
}
